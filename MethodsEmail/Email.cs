...
namespace MethodsEmail
{
    public class Email
    {
        ...
        public Email()
        {
            EnderecoOrigem = "no-reply@clinicadocoracaosl.com.br";
            SenhaEnderecoOrigem = "Senha2018@BMED";
            NomeEnderecoOrigem = "Clínica do Coração SL";
            Host = "mail.clinicadocoracaosl.com.br";
            Port = 8889;
